...
class InputSimulation(Input):
    ...
    dynamic = {
        ...
        "ffcavphfpsocket": (
            iforcefields.InputFFCavPhFPSocket,
            {"help": iforcefields.InputFFCavPhFPSocket.default_help},
        ),
        "ffcavph": (
            iforcefields.InputFFCavPh,
            {"help": iforcefields.InputFFCavPh.default_help},
        ),
    }
